...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandClubAppWidget.url'
        db.add_column(u'core_brandclubappwidget', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandClubAppWidget.url'
        db.delete_column(u'core_brandclubappwidget', 'url')
