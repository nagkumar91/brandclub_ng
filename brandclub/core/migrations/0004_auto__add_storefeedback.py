...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreFeedback'
        db.create_table(u'core_storefeedback', (
            ...
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback', to=orm['core.Store'])),
        ))
        db.send_create_signal(u'core', ['StoreFeedback'])


    def backwards(self, orm):
        # Deleting model 'StoreFeedback'
        db.delete_table(u'core_storefeedback')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
