...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.slug_name'
        db.add_column(u'core_store', 'slug_name',
                      self.gf('django.db.models.fields.SlugField')(default='-1', max_length=100),
                      keep_default=False)

        # Adding field 'Store.map_name'
        db.add_column(u'core_store', 'map_name',
        ...
        # Adding field 'Cluster.map_name'
        db.add_column(u'core_cluster', 'map_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Store.map_name'
        db.delete_column(u'core_store', 'map_name')
        ...
        # Deleting field 'Cluster.map_name'
        db.delete_column(u'core_cluster', 'map_name')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'core.store': {
            ...
            'slug_name': ('django.db.models.fields.SlugField', [], {'default': "'-1'", 'max_length': '100'}),
