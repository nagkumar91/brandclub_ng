...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.custom_form_slug'
        db.add_column(u'core_store', 'custom_form_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.custom_form_slug'
        db.delete_column(u'core_store', 'custom_form_slug')
