...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NavMenu'
        db.create_table(u'core_navmenu', (
            (u'content_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Content'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['NavMenu'])

        # Adding model 'OrderedNavMenuContent'
        db.create_table(u'core_orderednavmenucontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nav_menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.NavMenu'])),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nav_contents', to=orm['core.Content'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['OrderedNavMenuContent'])


    def backwards(self, orm):
        # Deleting model 'NavMenu'
        db.delete_table(u'core_navmenu')

        # Deleting model 'OrderedNavMenuContent'
        db.delete_table(u'core_orderednavmenucontent')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
