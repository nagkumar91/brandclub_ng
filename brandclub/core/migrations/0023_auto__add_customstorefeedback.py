...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomStoreFeedback'
        db.create_table(u'core_customstorefeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('recommendation_options', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('product_range_options', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('staff_options', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('overall_experience', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('how_long_have_you_been_shopping', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('any_other_feedback', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_feedback', to=orm['core.Store'])),
        ))
        db.send_create_signal(u'core', ['CustomStoreFeedback'])


    def backwards(self, orm):
        # Deleting model 'CustomStoreFeedback'
        db.delete_table(u'core_customstorefeedback')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
