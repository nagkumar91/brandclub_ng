...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppPreference'
        db.create_table(u'core_apppreference', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['AppPreference'])

        # Adding model 'BrandClubAppUser'
        db.create_table(u'core_brandclubappuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('device_id', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ...
            ('fb_id', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('email_id', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True, blank=True)),
            ('date_of_birth', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('imei', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('app_version', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('mobile_make', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('mobile_model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('profile_pic', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=8, blank=True)),
            ...
            ('registration_id', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('enable_notifications', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'core', ['BrandClubAppUser'])

        # Adding M2M table for field preferences on 'BrandClubAppUser'
        m2m_table_name = db.shorten_name(u'core_brandclubappuser_preferences')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brandclubappuser', models.ForeignKey(orm[u'core.brandclubappuser'], null=False)),
            ('apppreference', models.ForeignKey(orm[u'core.apppreference'], null=False))
        ))
        db.create_unique(m2m_table_name, ['brandclubappuser_id', 'apppreference_id'])


    def backwards(self, orm):
        # Deleting model 'AppPreference'
        db.delete_table(u'core_apppreference')

        # Deleting model 'BrandClubAppUser'
        db.delete_table(u'core_brandclubappuser')

        # Removing M2M table for field preferences on 'BrandClubAppUser'
        db.delete_table(db.shorten_name(u'core_brandclubappuser_preferences'))
    ...
    models = {
        ...
        u'core.brandclubuser': {
            ...
            'coupon_generated_at': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coupon_user'", 'to': u"orm['core.Store']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            ...
            'user_unique_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
        u'core.city': {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
