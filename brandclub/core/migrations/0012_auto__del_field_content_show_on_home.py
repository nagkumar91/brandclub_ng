...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Content.show_on_home'
        db.delete_column(u'core_content', 'show_on_home')


    def backwards(self, orm):
        # Adding field 'Content.show_on_home'
        db.add_column(u'core_content', 'show_on_home',
