...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ContentType', fields ['name']
        db.create_unique(u'core_contenttype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContentType', fields ['name']
        db.delete_unique(u'core_contenttype', ['name'])
