...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandClubUser'
        db.create_table(u'core_brandclubuser', (
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, primary_key=True)),
            ('mac_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user_unique_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('coupon_current_value', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('loyalty_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('qr_code', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('last_updated_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('coupon_generated_at', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon_user', to=orm['core.Store'])),
        ))
        db.send_create_signal(u'core', ['BrandClubUser'])

        # Adding field 'Store.username'
        db.add_column(u'core_store', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.password'
        db.add_column(u'core_store', 'password',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.auth_key'
        db.add_column(u'core_store', 'auth_key',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BrandClubUser'
        db.delete_table(u'core_brandclubuser')

        # Deleting field 'Store.username'
        db.delete_column(u'core_store', 'username')

        # Deleting field 'Store.password'
        db.delete_column(u'core_store', 'password')

        # Deleting field 'Store.auth_key'
        db.delete_column(u'core_store', 'auth_key')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
