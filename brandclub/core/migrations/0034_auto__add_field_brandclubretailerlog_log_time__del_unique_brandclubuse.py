...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BrandClubRetailerLog.log_time'
        db.add_column(u'core_brandclubretailerlog', 'log_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandClubRetailerLog.log_time'
        db.delete_column(u'core_brandclubretailerlog', 'log_time')
