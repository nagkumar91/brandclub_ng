...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Web.content'
        db.alter_column(u'core_web', 'content', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'Web.content'
        db.alter_column(u'core_web', 'content', self.gf('django.db.models.fields.TextField')())
