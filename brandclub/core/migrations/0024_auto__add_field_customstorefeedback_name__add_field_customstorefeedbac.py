...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomStoreFeedback.name'
        db.add_column(u'core_customstorefeedback', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomStoreFeedback.phone_number'
        db.add_column(u'core_customstorefeedback', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomStoreFeedback.name'
        db.delete_column(u'core_customstorefeedback', 'name')

        # Deleting field 'CustomStoreFeedback.phone_number'
        db.delete_column(u'core_customstorefeedback', 'phone_number')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
