...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brand.footfall'
        db.add_column(u'core_brand', 'footfall',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


        # Changing field 'StoreFeedback.email_id'
        db.alter_column(u'core_storefeedback', 'email_id', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True))
        # Adding field 'Store.demo'
        db.add_column(u'core_store', 'demo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Store.paid'
        db.add_column(u'core_store', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brand.footfall'
        db.delete_column(u'core_brand', 'footfall')


        # Changing field 'StoreFeedback.email_id'
        db.alter_column(u'core_storefeedback', 'email_id', self.gf('django.db.models.fields.EmailField')(default=None, max_length=100))
        # Deleting field 'Store.demo'
        db.delete_column(u'core_store', 'demo')

        # Deleting field 'Store.paid'
        db.delete_column(u'core_store', 'paid')
