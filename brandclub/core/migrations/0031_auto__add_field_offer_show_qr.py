...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.show_qr'
        db.add_column(u'core_offer', 'show_qr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.show_qr'
        db.delete_column(u'core_offer', 'show_qr')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
