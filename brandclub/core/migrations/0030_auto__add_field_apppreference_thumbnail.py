...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppPreference.thumbnail'
        db.add_column(u'core_apppreference', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppPreference.thumbnail'
        db.delete_column(u'core_apppreference', 'thumbnail')
