...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderedStoreContent'
        db.create_table(u'core_orderedstorecontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Store'])),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Content'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['OrderedStoreContent'])

        # Adding unique constraint on 'OrderedStoreContent', fields ['store', 'order']
        db.create_unique(u'core_orderedstorecontent', ['store_id', 'order'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'OrderedStoreContent', fields ['store', 'order']
        db.delete_unique(u'core_orderedstorecontent', ['store_id', 'order'])

        # Deleting model 'OrderedStoreContent'
        db.delete_table(u'core_orderedstorecontent')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'core.orderedstorecontent': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('store', 'order'),)", 'object_name': 'OrderedStoreContent'},
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Content']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
