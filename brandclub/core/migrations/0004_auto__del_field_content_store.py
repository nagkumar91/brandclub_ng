...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Content.store'
        db.delete_column(u'core_content', 'store_id')
    ...
    def backwards(self, orm):
        # Adding field 'Content.store'
        db.add_column(u'core_content', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contents', null=True, to=orm['core.Store'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.content': {
            ...
            'store': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contents'", 'symmetrical': 'False', 'to': u"orm['core.Store']"}),
