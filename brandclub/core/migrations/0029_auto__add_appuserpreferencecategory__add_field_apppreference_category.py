...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppUserPreferenceCategory'
        db.create_table(u'core_appuserpreferencecategory', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['AppUserPreferenceCategory'])

        # Adding field 'AppPreference.category'
        db.add_column(u'core_apppreference', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AppUserPreferenceCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AppUserPreferenceCategory'
        db.delete_table(u'core_appuserpreferencecategory')

        # Deleting field 'AppPreference.category'
        db.delete_column(u'core_apppreference', 'category_id')


    models = {
        u'core.apppreference': {
            'Meta': {'object_name': 'AppPreference'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.AppUserPreferenceCategory']", 'null': 'True', 'blank': 'True'}),
