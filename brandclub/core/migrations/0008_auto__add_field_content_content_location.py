...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.content_location'
        db.add_column(u'core_content', 'content_location',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=100),
                      keep_default=False)

        # Adding M2M table for field content on 'Cluster'
        m2m_table_name = db.shorten_name(u'core_cluster_content')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cluster', models.ForeignKey(orm[u'core.cluster'], null=False)),
            ('content', models.ForeignKey(orm[u'core.content'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cluster_id', 'content_id'])


    def backwards(self, orm):
        # Deleting field 'Content.content_location'
        db.delete_column(u'core_content', 'content_location')

        # Removing M2M table for field content on 'Cluster'
        db.delete_table(db.shorten_name(u'core_cluster_content'))
    ...
    models = {
        ...
        u'core.content': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
