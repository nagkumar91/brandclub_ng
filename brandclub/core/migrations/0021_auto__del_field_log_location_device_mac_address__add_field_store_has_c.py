...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Log.location_device_mac_address'
        db.delete_column(u'core_log', 'location_device_mac_address')

        # Adding field 'Store.has_custom_form'
        db.add_column(u'core_store', 'has_custom_form',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Log.location_device_mac_address'
        db.add_column(u'core_log', 'location_device_mac_address',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Store.has_custom_form'
        db.delete_column(u'core_store', 'has_custom_form')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
