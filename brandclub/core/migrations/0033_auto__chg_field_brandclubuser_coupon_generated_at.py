...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrandClubUser.coupon_generated_at'
        db.alter_column(u'core_brandclubuser', 'coupon_generated_at_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Store']))

    def backwards(self, orm):

        # Changing field 'BrandClubUser.coupon_generated_at'
        db.alter_column(u'core_brandclubuser', 'coupon_generated_at_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Store']))
