...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandClubRedemptionLog'
        db.create_table(u'core_brandclubredemptionlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('bc_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BrandClubUser'], null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Store'], null=True, blank=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Cluster'], null=True, blank=True)),
            ('log_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['BrandClubRedemptionLog'])


    def backwards(self, orm):
        # Deleting model 'BrandClubRedemptionLog'
        db.delete_table(u'core_brandclubredemptionlog')
    ...
    models = {
        ...
        u'core.content': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
