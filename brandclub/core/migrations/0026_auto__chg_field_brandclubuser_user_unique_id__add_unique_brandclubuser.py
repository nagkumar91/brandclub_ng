...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrandClubUser.user_unique_id'
        db.alter_column(u'core_brandclubuser', 'user_unique_id', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100))
        # Adding unique constraint on 'BrandClubUser', fields ['user_unique_id']
        db.create_unique(u'core_brandclubuser', ['user_unique_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BrandClubUser', fields ['user_unique_id']
        db.delete_unique(u'core_brandclubuser', ['user_unique_id'])


        # Changing field 'BrandClubUser.user_unique_id'
        db.alter_column(u'core_brandclubuser', 'user_unique_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
