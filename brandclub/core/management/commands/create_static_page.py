    ...
    def _generate_page(self, dir, cluster_id, device_id, store):
        ...
        for cluster_store in stores:
            ...
            for individual_content in contents:
                if individual_content.content_type is ctype_slideshow:
                    self._generate_slideshow(individual_content.id, cluster_id, device_id, dir)
                if individual_content.content_type is ctype_wallpaper:
                    self._generate_wallpapers(individual_content.id, cluster_id, device_id, dir)
