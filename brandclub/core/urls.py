...
urlpatterns = patterns('',
                       ...
                       url(r'rd_qr/(?P<user_id>[\-\w]+)/$', 'core.views.redeem_coupon_for_user'),
                       url(r'rd_qr/(?P<user_id>[\-\w]+)/(?P<retailer_id>[\-\w]+)/$', 'core.views.redeem_coupon_for_user_retail'),
                       url(r'free_internet_codes/(?P<st_id>\d+)/$', 'core.views.free_internet_codes'),
                       url(r'retailer_credentials/(?P<cluster_id>\d+)/$', 'core.views.retailer_credentials'),
                       url(r'free_internet_confirm/(?P<content_id>\d+)/$', 'core.views.free_internet_confirm'),
                       url(r'retailer_form_sumbit/(?P<user_pk>[\-\w]+)/(?P<store_pk>[\-\w]+)/(?P<amount>[\-\w]+)/(?P<phone>[\-\w]+)/$', 'core.views.retailer_form_sumbit'),
